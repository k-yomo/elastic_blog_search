...
func handleHTTPServer(ctx context.Context, u *url.URL, registerEndpoints *register.Endpoints, wg *sync.WaitGroup, errc chan error, logger *log.Logger, debug bool) {
